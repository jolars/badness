...
| --- | --- |
| Environment frames and bodies | `environment_empty_body`, `environment_special_character_names`, `begin_tail_is_body`, `environment_leading_body_command`, `environment_inline_prose_boundaries`, `environment_adjacent_siblings`, `environment_in_command_argument`, `environment_in_scoped_group` |
