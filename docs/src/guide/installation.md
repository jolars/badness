...
badness is written in Rust (edition 2024). With a Rust toolchain installed, build
from a checkout:
...
The binary lands at `target/release/badness`. Copy it onto your `PATH`, or run it
in place.
