//! Conservative expl3 call reads shared by the semantic lint rules.
//!
...
fn toggle_may_be_an_operand(node: &SyntaxNode) -> bool {
    if super::rules::in_reference_position(node) {
        return true;
    }
...
fn definition_kind(stem: &str) -> Option<bool> {
