...
//! punctuation for it. A [`Severity::Warning`]. Report-only in this slice — a safe
//! deletion fix (removing the field *and* its separating comma so the result stays
//! format-clean per Tenet 5) is a noted follow-up.
//!
