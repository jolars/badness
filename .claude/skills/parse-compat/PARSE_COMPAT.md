...
- **Skeleton similarity:** 75.4%  _(Dice coefficient over skeleton lines)_
- **File concordance:** 23.1%  (6/26 files identical after projection)
- **Intentional deviations:** 20  ·  **Unexplained divergences:** 0
- **Skipped:** 1 (badness could not parse cleanly)
- **texlab parse errors:** 1 (badness-clean inputs texlab flagged — see the gate, `parse_oracle.rs`)
